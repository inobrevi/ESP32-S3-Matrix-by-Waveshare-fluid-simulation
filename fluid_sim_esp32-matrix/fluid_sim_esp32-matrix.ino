...
#include <Wire.h>
// #include <MPU6050.h>
#include "SensorQMI8658.hpp" // changed MPU to the one used by Waveshare ESP32-S3-Matrix
...
#define FLUID_PARTICLES 25  //80/64
...
void initMPU() {
    ...
    mpu.dumpCtrlRegister();               // printf register configuration information
